...
const SQL_SETUP = `-- 1. ENSURE TYPE COLUMN EXISTS IN RECIPES
ALTER TABLE recipes ADD COLUMN IF NOT EXISTS type text DEFAULT 'Regular';

-- 2. RESET FOREIGN KEYS FOR PUBLIC MODE (IF APPLICABLE)
...
-- 4. DISABLE RLS FOR EASY ACCESS (OR CONFIGURE POLICIES)
